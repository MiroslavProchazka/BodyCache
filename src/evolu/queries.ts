  ...
  evolu.createQuery((db) =>
    db
      ...
      .select([
        ...
        'workoutExercise.supersetGroup as supersetGroup',
  ...
  evolu.createQuery((db) =>
    db
      ...
      .select([
        ...
        'exerciseSet.elevationMeters as elevationMeters',
  ...
  evolu.createQuery((db) =>
    db
      ...
      .select([
        ...
        'planExercise.supersetGroup as supersetGroup',
        'exercise.name as exerciseName',
        'exercise.type as exerciseType',
        'exercise.bodyPart as bodyPart',
        'exercise.equipment as equipment',
  ...
  evolu.createQuery((db) =>
    db
      ...
      .select([
        ...
        'planSet.elevationMeters as elevationMeters',
